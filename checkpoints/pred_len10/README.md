...
It is the 10 Hz baseline setting: an MDM-inspired Transformer denoiser trained with
`data.root_relative: true`, `pred_len: 10`, `data.fps: 10`, and rectified-flow sampling.
